         ...
         if (typeof google != 'undefined') {
            ...
            if ($('.map-canvas-default').length) {
                $(".map-canvas-default").googleMap({
                    ...
                    coords: [10.696906, 76.3222083], // Government Polytechnic College coordinates
                ...
                $(".map-canvas-default").addMarker({
                    ...
                    text: 'Chelakkara, Kerala, India',
                    icon: lgx_path + '/assets/img/map/map-icon.png' // Adjust the path to your map icon
                });
            }
        }
